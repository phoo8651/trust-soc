...
from crypto_utils import maybe_encrypt
...
def build_event_payload(
    ...
    encrypted_ip = maybe_encrypt(ecs["network.client.ip"])
    return {
        ...
        "source_ip_enc": encrypted_ip or _hash_bytes(ecs["network.client.ip"].encode("utf-8")),
