...
if IS_PG:
    class RawLog(Base):
        ...
        __table_args__ = (
            ...
            Index("idx_raw_logs_ts_brin", "ts", postgresql_using="brin"),
...
if IS_PG:
    class Event(Base):
        ...
        __table_args__ = (
            ...
            Index("idx_events_ts_brin", "ts", postgresql_using="brin"),
            {"postgresql_partition_by": "RANGE (ts)"},
        )
else:
    class Event(Base):
...
if IS_PG:
    class Incident(Base):
        ...
        __table_args__ = (
            Index("idx_incidents_client_created", "client_id", "created_at"),
            Index("idx_incidents_created_brin", "created_at", postgresql_using="brin"),
